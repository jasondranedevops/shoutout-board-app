...
const occasions = [
  ...
  { value: 'company_celebration',    label: 'Company Celebration',    emoji: '🎈' },
  ...
  { value: 'recruiting_onboarding',  label: 'Recruiting & Onboarding', emoji: '🤝' },
  { value: 'dei_celebration',        label: 'DEI Celebration',        emoji: '✋' },
  { value: 'office_competition',     label: 'Office Competition',     emoji: '🥇' },
  { value: 'department_event',       label: 'Department Event',       emoji: '📋' },
  { value: 'sympathy',               label: 'Sympathy',               emoji: '🌸' },
  { value: 'employee_appreciation',  label: 'Employee Appreciation',  emoji: '👍' },
  { value: 'holiday_celebration',    label: 'Holiday Celebration',    emoji: '🎄' },
